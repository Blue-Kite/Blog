...
next build를 실행하면, Next.js는 HTML/CSS/JS가 있는 out 폴더를 만든다. 현재 모든 페이지가 빌드 타임에 생성된 SSG이다.

![next-build-result](/images/make-blog/build.png)

배포 과정을 요약하면 다음 그림과 같다.

![aws-deploy](/images/make-blog/deploy.png)
